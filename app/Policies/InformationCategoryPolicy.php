...
class InformationCategoryPolicy
{
     ...
     */
    public function restore(User $user, InformationCategory $informationCategory): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, InformationCategory $informationCategory): bool
    {
        return false;
    }
}
